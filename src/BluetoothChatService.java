...
public class BluetoothChatService {
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        this.write(("lengthc" + Integer.toString(length)).getBytes());
        ...
        this.write(myKeys.getBytes());
        Log.i("FPM", "Send my key to the paired side.");
    }
            ...
            while (true) {
                try {
                	...
                	while( avail > 0){
                		...
                		if(totalBytes != 0){
                			Log.i("FPM", "Read bytes: " + totalBytes);
                		}*/
                	...
                	if (totalBytes == 0)
                		continue;
                    // Send the obtained bytes to the UI Activity
                    mHandler.obtainMessage(BluetoothChat.MESSAGE_READ, totalBytes, -1, data.toByteArray())
                            .sendToTarget();
                    data.reset();
